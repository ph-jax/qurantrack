export default {
  ...
  dashboard: {
    ...
    educator: 'educator',
    adminDescription: 'Keep learning, people, and organization setup moving.',
    teacherDescription: 'Continue today’s teaching and student progress work.',
    loadError: 'Today’s workspace could not be loaded. Try refreshing the page.',
    readOnlyTitle: 'Your QuranTrack workspace is ready',
    readOnlyBody: 'Your current role does not include student or class management.',
    attentionSetup: 'Needs setup',
    attentionSetupBody: 'Students missing an active class or guardian updates.',
    continueLearning: 'Continue student work',
    continueLearningBody: 'Open a student workspace to review or record progress.',
    completeSetup: 'Complete class or family setup',
    openWorkspace: 'Open learning workspace',
    nothingNeedsAttention: 'No student setup issues need attention.',
    activeClasses: 'Active classes',
    activeClassesBody: 'Open a class to review its roster and continue learning work.',
    viewAll: 'View all',
    scheduleNotSet: 'Schedule not set',
    setupTitle: 'Organization setup',
    setupBody: 'Complete the foundations your teachers and families rely on.',
    nextStep: 'Your next step',
    nextStepBody: 'Choose a student and continue their learning record.',
    checkClasses: 'Create and schedule classes',
    checkStudents: 'Add students',
    checkFamilies: 'Connect family contacts',
    checkProgram: 'Review the learning program',
    chooseStudent: 'Choose a student',
    chooseStudentBody: 'Review curriculum, record progress, or prepare a family update.',
  ...
  manage: {
    title: 'Manage QuranTrack',
    description: 'Organization setup, people, curriculum, communication, and security.',
    items: {
      teachers: 'Manage staff access, roles, and invitations.',
      families: 'Manage guardians, student links, and notification preferences.',
      program: 'Manage tracks, levels, lessons, and assignments.',
      notifications: 'Review guardian notification outcomes and safe retries.',
      settings: 'Manage organization identity, sender details, and security.',
    },
  },
  pilot: {
    active: 'Active',
    ...
    students: {
      ...
      noResults: 'No students match that search.',
      openWorkspace: 'Open learning workspace',
      back: 'Back to students',
      noClass: 'No active class',
      workspaceTabs: 'Student workspace',
      tabs: {
        overview: 'Overview',
        progress: 'Progress',
      ...
      currentLearningBody: 'The student’s active track and current level.',
      continueProgress: 'Continue progress',
      latestActivity: 'Latest activity',
      latestActivityBody: 'The most recent saved learning update.',
      noComment: 'No teacher comment was added.',
      quickFacts: 'Student details',
      progressHistoryBody: 'Published updates, drafts, homework, and guardian delivery status.',
      curriculumBody: 'Assigned tracks, current levels, and completed lessons.',
      curriculumSetup: 'Curriculum assignment',
      curriculumSetupBody: 'Assign a track or change the student’s current level.',
    },
    guardians: {
    ...
    program: {
      ...
      levelCount_one: '{{count}} level',
      levelCount_other: '{{count}} levels',
      lessonCount_one: '{{count}} lesson',
      lessonCount_other: '{{count}} lessons',
      expandAll: 'Expand all',
      collapseAll: 'Collapse all',
      expandTrack: 'Expand track {{name}}',
      collapseTrack: 'Collapse track {{name}}',
      expandLevel: 'Expand level {{name}}',
      collapseLevel: 'Collapse level {{name}}',
    },
    outcomes: {
      passed: 'Passed',
      practiced: 'Practiced',
